...
class Frame extends JFrame implements ActionListener {
    ...
    JTextField text;
    JButton btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnDot, btnAdd, btnSub, btnMulti, btnDiv, btnEqual, btnClr,btnSqr,btnRoot;
    int flag;
